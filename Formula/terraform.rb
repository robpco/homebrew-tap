class Terraform < Formula
  ...
  url "https://releases.hashicorp.com/terraform/0.13.5/terraform_0.13.5_darwin_amd64.zip" if OS.mac?
  sha256 "03f7b636638c587c3b03a4b3d1d4cab77c872ad5f7e55405ddaf38dfb94e0e89" if OS.mac?
  version "0.13.5"
  ...
  def install
    if OS.linux?
      system "./terraform-install.sh", "-c", "-i", "0.13.5"
    end
