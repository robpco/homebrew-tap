class Terraform < Formula
  ...
  url "https://releases.hashicorp.com/terraform/0.12.1/terraform_0.12.1_darwin_amd64.zip" if OS.mac?
  sha256 "3c5b0aa8f3acf477a5d5ae997174bd16d49bb0789915b5a40a6deb39692a5c8d" if OS.mac?
  version "0.12.1"
  ...
  def install
    if OS.linux?
      system "./terraform-install.sh", "-c", "-i", "0.12.1"
    end
