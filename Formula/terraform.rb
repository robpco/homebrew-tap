class Terraform < Formula
  ...
  url "https://releases.hashicorp.com/terraform/0.11.9-beta1/terraform_0.11.9-beta1_darwin_amd64.zip" if OS.mac?
  sha256 "a95ac475acd068a876a1068fa90cb2e9370e1c28e8c7fc57b7db016629b533be" if OS.mac?
  ...
  def install
    if OS.linux?
      system "./terraform-install.sh", "-c", "-i", "0.11.9-beta1"
    end
